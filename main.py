...
def main():
    ...
    # Save raw IR
    with open("output_raw_21.ll", "w", encoding="utf-8") as f:
        f.write(raw_llvm_ir)
    ...
    try:
        ...
        # Save optimized IR
        with open("output_opt_21.ll", "w", encoding="utf-8") as f:
            f.write(optimized_ir)

        print(
            "✅ تم تحسين الكود بنجاح! قارن بين output_raw_21.ll و output_opt_21.ll"
        )
